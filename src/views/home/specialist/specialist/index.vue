      ...
      <el-row>
        <el-col :span="12" class="col" v-for="(item,index) in specialistData" :key="index" >
          <div class="specialist-item line-animate-content">
            ...
            <div class="right">
              <h3 class="font20 specialistName" v-on:click="seeDetails(index)">{{item.name}}</h3>
          ...
          <div class="specialist-content">
            ...
            <div class="dispaly-content">
              ...
              <div v-if="currentNode == 'scientificResearchProject'" class="scientificResearchProject">
                <!-- 科研项目 -->
                <ul  v-for="(child,index) in specialistData[currentSpecialistIndex].scientificResearchProject" :key="index" >
                    <label> {{child.title}}</label>
                    <li 
                      class="item font14" 
                      v-for="(child2,index2) in child.content" 
                      :key="index2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ child2 }}</li>
                </ul>
              </div>
              <div v-if="currentNode == 'thesis'" class="thesis"> 
                <!-- 论文 -->
                <ul>
                    <li class="item font14" v-for="(child,index) in specialistData[currentSpecialistIndex].thesis" :key="index">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ child }}</li>
                </ul>
              </div>
    ...
    return {
      ...
      specialistData:{
        ...
        2:{
          ...
          thesis:[
            "S.Wang, J.Sun, B.Gao and J.Ma, VSRank: A Novel Framework for Ranking-based Collaborative Filtering, ACM Transactions on Intelligent Systems and Technology, 2014.",
            "Chaoran Cui, Jun Ma, Tao Lian, Zhumin Chen, Shuaiqiang Wang. Improving Image Annotation via Ranking-Oriented Neighbor Search and Learning-Based Keyword Propagation. Journal of the American Society for Information Science and Technology,2014",
            "S.Wang, Jun Ma, Evolving Choice Structures for Genetic Programming. Information Processing Letters. 111(20): 871-876, 2010.(SCI) ",
            "Xiaohui Han, Jun Ma, Yun Wu, Chaoran Cui. A novel machine learning approach to rank web forum posts. Soft Computing (SCI)",
            "S.Wang, Jun Ma. Formal Behavior Modeling and Effective Automatic Refinement. Information Sciences. 180(20): 3894-3913, 2010.",
            "S.Wang, Jun Ma, Qiang He. An Immune Programming Based Ranking Function Discovery Approach for Effective Information Retrieval. Expert Systems with Applications. 37(8): 5863-5871, 2010. ",
            "崔超然,马军. 一种综合考虑相关性和信息性的图像标签推荐方法. 计算机学报. Vol.36(3), Mar. 2013",
            " 马军, 宋玲, 韩晓晖, 闫泼. 基于网页上下文的Deep Web数据库分类. 软件学报, Vol.19(2), pp.267-272, Feb. 2008. (EI)",
            "郭磊，马军，陈竹敏, 姜浩然. 一种结合推荐对象间关联关系的社会化推荐算法. 计算机学报. Vol.37(1), 2014。",
            "Piji Li, Jun Ma, Lei Zhang. Results Selection Diversity for Web Image Retrieval. International Journal of Computer Mathematics, Vol.88(18), 2011, 3834-3851.(SCI) ",
            "Chaoran Cui, Jun Ma, A Hybrid Relevant-Diverse Approach for Image Re-ranking with Multiple Features. International Journal of Computer Mathematics, Vol.88(18), 2011, 3864-3881.(SCI)",
          ],
          ...
          scientificResearchProject:[
            {
              title:"负责：",
              content:[
                 "2018-2020  基于互动语言的在线社会关系语义化动态画像研究,  国家自然科学基金面上项目",
                "2014-2016  结合人物模型的社会媒体话题传播与影响力分析及预测,  天津市自然科学基金青年项目",
                "2012-2014  自然语言处理系统的自动化白箱分析评价方法，国家自然科学基金青年项目",
                " 2012  面向S2S，Bing字典和Bing翻译系统的网络众包翻译资源挖掘，微软高校合作项目",
              ]
            },{
              title:"参与项目：",
              content:[
                 "2017-2020 大数据和社会场景下的互动语言意图深度理解基础理论和关键技术研究,  国家自然科学基金重点项目",
                "2017-2020  Quantum Information Access and Retrieval Theory, 欧盟地平线 2020 计划项目",
                "2015-2018 类人智能知识理解与推理关键技术，国家863项目",
                "2013-2017互联网环境中文言语信息处理与深度计算的基础理论和方法，国家973项目"
              ]
            }
          ],
          thesis:[
